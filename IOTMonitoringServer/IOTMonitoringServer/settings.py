...
#IP de la instancia donde corre el viewer
ALLOWED_HOSTS = ["localhost", "54.161.111.216"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "3.82.209.39",  # Dirección IP de la base de datos
